...
class MockData {
  ...
  static final User demoUser = User(
    ...
    nickname: '별빛팬',
    profileImage: 'https://api.dicebear.com/7.x/adventurer-neutral/svg?seed=fan1&size=150',
    role: 'FAN',
    isVerified: true,
  ...
  static final List<IdolModel> idolModels = [
    IdolModel(
      ...
      profileImage: 'https://api.dicebear.com/7.x/adventurer-neutral/svg?seed=skystar&size=300',
    ...
    IdolModel(
      ...
      profileImage: 'https://api.dicebear.com/7.x/adventurer-neutral/svg?seed=miyu&size=300',
    ...
    IdolModel(
      ...
      profileImage: 'https://api.dicebear.com/7.x/adventurer-neutral/svg?seed=luna&size=300',
    ...
    IdolModel(
      ...
      profileImage: 'https://api.dicebear.com/7.x/adventurer-neutral/svg?seed=sakura&size=300',
    ...
    IdolModel(
      ...
      profileImage: 'https://api.dicebear.com/7.x/adventurer-neutral/svg?seed=yuki&size=300',
    ...
    IdolModel(
      ...
      stageName: '아리',
      category: IdolCategory.undergroundIdol,
      profileImage: 'https://api.dicebear.com/7.x/adventurer-neutral/svg?seed=ari&size=300',
      bio: '데뷔 6개월차\n연습생 기간: 1년\n목표: 첫 단독 콘서트',
...
여러분의 응원이 이 꿈을 현실로 만들어줄 거예요! 💕
      ...
      creatorId: 'idol-001',
      creatorName: '하늘별',
      creatorImage: 'https://api.dicebear.com/7.x/adventurer-neutral/svg?seed=skystar&size=100',
...
루나에게 잊지 못할 생일을 선물해주세요! 💜
      ...
      creatorImage: 'https://api.dicebear.com/7.x/adventurer-neutral/svg?seed=lunafc&size=100',
    ...
    CampaignModel(
      ...
      creatorId: 'idol-004',
      creatorName: '사쿠라',
      creatorImage: 'https://api.dicebear.com/7.x/adventurer-neutral/svg?seed=sakura&size=100',
      isVerifiedCreator: true,
      goalAmount: 8000000,
    ...
    CampaignModel(
      ...
      creatorImage: 'https://api.dicebear.com/7.x/adventurer-neutral/svg?seed=luna&size=100',
      isVerifiedCreator: true,
      goalAmount: 20000000,
  ...
  static final List<BubbleMessageModel> bubbleMessages = [
    BubbleMessageModel(
      ...
      idolId: 'idol-001',
      idolName: '하늘별',
      idolProfileImage: 'https://api.dicebear.com/7.x/adventurer-neutral/svg?seed=skystar&size=100',
    ...
    BubbleMessageModel(
      ...
      idolId: 'idol-003',
      idolName: '루나',
      idolProfileImage: 'https://api.dicebear.com/7.x/adventurer-neutral/svg?seed=luna&size=100',
      type: BubbleMessageType.text,
    ...
    BubbleMessageModel(
      ...
      idolId: 'idol-002',
      idolName: '미유',
      idolProfileImage: 'https://api.dicebear.com/7.x/adventurer-neutral/svg?seed=miyu&size=100',
      type: BubbleMessageType.image,
  ...
  static final List<AdFunding> adFundings = [
    AdFunding(
      ...
      targetIdolName: '루나',
      targetIdolImage: 'https://api.dicebear.com/7.x/adventurer-neutral/svg?seed=luna&size=100',
    ...
    AdFunding(
      ...
      targetIdolName: '하늘별',
      targetIdolImage: 'https://api.dicebear.com/7.x/adventurer-neutral/svg?seed=skystar&size=100',
  ...
  static final List<Map<String, dynamic>> posts = [
    {
      ...
      'author': {
        'id': 'idol-001',
        'nickname': '하늘별',
        'profileImage': 'https://api.dicebear.com/7.x/adventurer-neutral/svg?seed=skystar&size=100',
        'isVerified': true,
    ...
    },
    {
      ...
      'author': {
        'id': 'idol-002',
        'nickname': '미유',
        'profileImage': 'https://api.dicebear.com/7.x/adventurer-neutral/svg?seed=miyu&size=100',
        'isVerified': true,
        'category': 'MAID_CAFE',
      },
    ...
    },
    {
      ...
      'author': {
        'id': 'idol-003',
        'nickname': '루나',
        'profileImage': 'https://api.dicebear.com/7.x/adventurer-neutral/svg?seed=luna&size=100',
        'isVerified': true,
        'category': 'UNDERGROUND_IDOL',
      },
    ...
    },
    {
      ...
      'author': {
        'id': 'idol-005',
        'nickname': '유키',
        'profileImage': 'https://api.dicebear.com/7.x/adventurer-neutral/svg?seed=yuki&size=100',
        'isVerified': true,
        'category': 'VTUBER',
      },
    ...
    },
    {
      ...
      'author': {
        'id': 'idol-004',
        'nickname': '사쿠라',
        'profileImage': 'https://api.dicebear.com/7.x/adventurer-neutral/svg?seed=sakura&size=100',
        'isVerified': true,
        'category': 'COSPLAYER',
      },
    ...
    },
    {
      ...
      'author': {
        'id': 'idol-006',
        'nickname': '아리',
        'profileImage': 'https://api.dicebear.com/7.x/adventurer-neutral/svg?seed=ari&size=100',
        'isVerified': false,
        'category': 'UNDERGROUND_IDOL',
      },
  ...
  static final List<Map<String, dynamic>> events = [
    // 12월 21일
    {
      ...
      'location': '서울',
      'performers': [
        {'id': 'idol-001', 'name': '하늘별', 'profileImage': 'https://api.dicebear.com/7.x/adventurer-neutral/svg?seed=skystar&size=100'},
      ],
      'price': 30000,
      'category': 'LIVE',
      'color': 0xFF4CAF50,
    },
    {
      ...
      'location': '도쿄',
      'performers': [
        {'id': 'idol-003', 'name': '루나', 'profileImage': 'https://api.dicebear.com/7.x/adventurer-neutral/svg?seed=luna&size=100'},
        {'id': 'idol-006', 'name': '아리', 'profileImage': 'https://api.dicebear.com/7.x/adventurer-neutral/svg?seed=ari&size=100'},
      ],
      'price': 45000,
      'category': 'CONCERT',
      'color': 0xFFE91E63,
    ...
    },
    {
      ...
      'location': '도쿄',
      'performers': [
        {'id': 'idol-002', 'name': '미유', 'profileImage': 'https://api.dicebear.com/7.x/adventurer-neutral/svg?seed=miyu&size=100'},
      ],
      'price': 28000,
      'category': 'LIVE',
      'color': 0xFF00BCD4,
    ...
    },
    {
      ...
      'location': '도쿄',
      'performers': [
        {'id': 'idol-004', 'name': '사쿠라', 'profileImage': 'https://api.dicebear.com/7.x/adventurer-neutral/svg?seed=sakura&size=100'},
      ],
      'price': 38000,
      'category': 'CONCERT',
      'color': 0xFFE91E63,
    ...
    },
    {
      ...
      'location': '도쿄',
      'performers': [
        {'id': 'idol-005', 'name': '유키', 'profileImage': 'https://api.dicebear.com/7.x/adventurer-neutral/svg?seed=yuki&size=100'},
      ],
      'price': 55000,
      'category': 'SPECIAL',
      'color': 0xFF9C27B0,
